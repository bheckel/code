...
7 77 701 701
  ;
run;
title "&SYSDSN";proc print data=large width=minimum heading=H NOobs; run;title;
...
5 55 5 500
  ;
run;
title "&SYSDSN";proc print data=small width=minimum heading=H NOobs; run;title;
...
title "Inner join &SYSDSN";proc print data=innerjoin width=minimum heading=H NOobs; run;title;
