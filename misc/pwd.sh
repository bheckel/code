...
#
# E.g. $ ~/pwd.sh/pwd.sh w me@gmail.com 20
#      $ ~/pwd.sh/pwd.sh w 'me@gmail.com google.com'
#      $ ~/pwd.sh/pwd.sh r me@gmail.com  <--implied wildcarding
#      $ ~/pwd.sh/pwd.sh d 'me@gmail.com google.com'
#
# Debug: $ echo mypw | gpg --decrypt --armor --batch --passphrase-fd 0 pwd.sh.safe
#
# Modified: Tue 15 Nov 2016 14:15:10 (Bob Heckel)
...
safe="${PWDSH_SAFE:=/cygdrive/c/Users/bheckel_2/Documents/My\ Dropbox/Public/misc/computer/dukkha}"
...
read_pass () {
  ...
  printf "\n\n"
  decrypt ${password} ${safe} | grep -iP "^.*${username}.*$" || fail "Decryption failed"
}
