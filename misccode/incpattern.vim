...
"
" Modified: Wed 05 May 2004 11:08:05 (Bob Heckel -- renamed to avoid name
"                                     collision with old Inc)
"=========================================================================
...
"endfunction
"
"command! -n=* -range Inc :<line1>,<line2>call IncPattern(<f-args>)
...
command! -n=* -range IncPat :<line1>,<line2>call IncPattern(<f-args>)
