...
" Modified: Tue 06 Oct 2009 12:03:41 (Bob Heckel)
...
syn keyword vimperatorCommand ab[breviate] ab[clear] addo[ns] au[tocmd] b[uffer] ba[ck] bd[elete] beep bma[rk] bmarks buffers
    ...
    \ delbm[arks] delc[ommand] delmac[ros] delm[arks] delqm[arks] dia[log] dl downl[oads] e[dit] ec[ho] echomsg echoe[rr] em[enu]
...
syn keyword vimperatorOption activate act activelinkfgcolor alfc activelinkbgcolor albc complete cpt defsearch ds editor
    ...
    \ vbs visualbell vb novisualbell novb visualbellstyle wildcase wildmode wim wildoptions wop wordseparators wsp
    \ contained
