This is the one I used before upgrading Cygwin in Feb 2004.  May or may not
work but it does have some MDDB, SQL Ledger, etc. that I want to keep.

##
## httpd.conf -- Apache HTTP server configuration file
##

# Modified: Wed 16 Oct 2002 14:22:35 (Bob Heckel -- for SAS IntrNet)
# Modified: Mon 21 Oct 2002 09:30:26 (Bob Heckel)
...
ServerAdmin bobh@localhost.localdomain
...
# Testing MDDB SAS 2003-08-18.
###DocumentRoot "/c/InetPub/wwwroot"
DocumentRoot "/c/InetPub/wwwroot/sasweb/"
###DocumentRoot "/home/bqh0/public_html/"

# bobh: now go edit Directory below
...
<Directory "/c/InetPub/wwwroot/sasweb">
#
...
# CDC box is configured in /etc
ErrorLog /etc/apache/error_log
...
CustomLog /etc/apache/access_log common
...
<IfModule mod_alias.c>
    ...
    Alias /intrnet/ "/home/bqh0/public_html/sasweb/"
    <Directory "/home/bqh0/public_html/sasweb/">
        Options Indexes MultiViews
        AllowOverride None
        Order allow,deny
        Allow from all
    ...
    ScriptAlias /cgi-bin/ "/home/bqh0/public_html/cgi-bin/"
...
# For SQL-Leger 2003-10-03
Include /etc/apache/sql-ledger-httpd.conf
