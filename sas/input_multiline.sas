  ...
  * Modified: Wed 20 Nov 2013 10:10:34 (Bob Heckel)
  *----------------------------------------------------------------------------
  */
 ...
 */
data work.readit;
  /* Code the var common to each input line.  rec_type is the indicator
   * variable.
   */
...
/* Other options that require you know the pattern of data indicator: */

/* Same -- Separate INPUTs */
data work.separate;
  input @1 rec_type $char2.
        @3 surveyno $char4.
        @7 city $2.
...
/* Better -- Using slash '/'  The +0 in (+0 1.) is optional as demonstrated
 * here. 
 */
data work.slash;
  input @1 rec_type $char2.
