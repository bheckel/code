...
ods tagsets.tableeditor file='filename.html' nogtitle
  options(
...
endsas;
ods tagsets.tableeditor file='temp2.html' options(header_bgcolor="black");

proc print data=sashelp.class;
title 'Tagset tableeditor';
run;
ods tagsets.tableeditor close;
...
define event pivot_tables_single;
 ...
 do /if $ptsource_range;
  ...
  /* Fix the hard coded range to work with worksheet location */
    ...
    do / if any($pivot_format,$pivot_grandtotal);
        do / if $pivot_format and ^exist($pivot_grandtotal);
          ...
          do /if cmp( $excel_save_prompt, "yes");
             ...
             do / if $options['DEFAULT_FILE'];
               ...
               do / if ^$update_target;
                 ...
                 put " wb.Sheets(""Sheet1"").Delete;" NL;
                 put " wb.Sheets(""Sheet2"").Delete;" NL;
                 put " wb.Sheets(""Sheet3"").Delete;" NL;
               done;
