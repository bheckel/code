...
$src = '/home/bheckel/projects/Vent_load/pullLIMStoDev';
...
$flist = '/home/bheckel/projects/Vent_load/loadLINKS/filelist.txt';

# Where we run this code from (chdir to)
###$limsdatadir = '/cygdrive/c/cygwin/home/bheckel/projects/EDreload/pullLIMSprod';
$limsdatadir = '/cygdrive/c/cygwin/home/bheckel/projects/Vent_load/pullLIMStoDev';

# !!! Also edit the w3m URL below !!!
####################################
...
print "make sure control filelist.txt is correct ($flist) !!!\n";
print "make sure control filelist.txt lists indres then sumres !!!\n";
print "make sure lims data dir is correct ($limsdatadir) !!!\n";
print "make sure w3m is pointing to correct server URL !!!\n";
print "start a '\$ tail -f \"x:\\SQL_Loader\\Logs\\LGI.log\" >| devload_tail.log'\n";
print "   or a '\$ tail -f \"\\\\kopsawn557\\SQL_Loader\\Logs\\LGI.log\" >| tstload_tail.log'\n";
print "   or a '\$ tail -f \"t:\\SQL_Loader\\Logs\\LGI.log\" >| tstload_tail.log'\n";
print "   or a '\$ tail -f \"p:\\SQL_Loader\\Logs\\LGI.log\" >| prodload_tail.log'\n";
print "ok? press y ";
...
print 'now manually stop $ tail -f';
print "\n\n";
